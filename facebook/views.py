            ...
            for message in entry['messaging']:
                ...
                if 'message' in message:
                    if 'quick_reply' in  message['message']:
                        ...
                        if payload == '1':
                            send_message = Message(text='1. 평일 아침 8시 이전 주문건까지 대부분 당일 배송됩니다. \n 2. 8시 이후 주문건은 다음날 배송됩니다. 금요일 8시 이후 주문건은 다음주 월요일에 배송됩니다.\n3. 브라운백 커피는 CJ 대한통운을 통해 커피를 보내드립니다.쇼핑몰에서 구매하신 경우, 택배 출고시 문자메시지로 송장 번호를 안내해드립니다. 문자로 받으신 송장번호를 복사하셔서 아래 CJ 대한통운 배송조회 사이트에서 조회해주시면 됩니다.\n4. 콜드브루와 원두를 같이 주문하시면 각각 다른 곳에서 배송되어, 택배를 두개로 나눠 받으십니다.더 궁금하신 점은 언제든 문의주세요. 감사합니다^^')
                        elif payload == '2':
                            send_message = Message(text='1. 샘플 신청 : 아래 링크를 눌러 샘플 발송에 필요한 정보를 입력해주시면 됩니다.맛 보시고 궁금하신 사항이나 추가 요청 사항이 있으시면 언제든 문의주세요! \n2. 샘플 배송 : 신청해주신 후 2~3일 이내 배송이 시작됩니다. 신청이 들어온 순서대로 순차적으로 배송해드리오니 조금만 기다려주세요^^')
                    else:
